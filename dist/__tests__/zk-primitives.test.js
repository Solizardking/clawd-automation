...
import { resolveZkPrimitivesRoot, loadZkManifest, getZkHealth, getZkCatalog, getZkPromptContext, } from "../zk/primitives.js";
...
describe("zk-primitives tree", () => {
    ...
    it("primary tools source registers zk tools", () => {
        const toolsSrc = fs.readFileSync(path.join(repoRoot, "src", "agent", "tools.ts"), "utf-8");
...
//# sourceMappingURL=zk-primitives.test.js.map