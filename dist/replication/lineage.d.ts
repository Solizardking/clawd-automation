 ...
 */
import type { AutomatonDatabase, ChildAutomaton, AutomatonConfig, ClawdClient } from "../types.js";
/**
 ...
 */
export declare function refreshChildrenStatus(clawd: ClawdClient, db: AutomatonDatabase): Promise<void>;
