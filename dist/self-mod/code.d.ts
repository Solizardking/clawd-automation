 ...
 */
import type { ClawdClient, AutomatonDatabase } from "../types.js";
/**
 ...
 * 7. Audit log entry
 */
export declare function editFile(clawd: ClawdClient, db: AutomatonDatabase, filePath: string, newContent: string, reason: string): Promise<{
    success: boolean;
    error?: string;
}>;
/**
