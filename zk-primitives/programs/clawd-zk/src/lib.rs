...
// Program ID generated from target/deploy/clawd_zk-keypair.json.
declare_id!("HsgY1m4uS64anpDLNwtpACsUMTsyM3xjkCriGbTBNFhk");

/// Light CPI signer derived from this program's deployment identity.
pub const LIGHT_CPI_SIGNER: light_sdk::CpiSigner =
    light_sdk::derive_light_cpi_signer!("HsgY1m4uS64anpDLNwtpACsUMTsyM3xjkCriGbTBNFhk");
